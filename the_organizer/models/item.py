...
class Item(AnObject, db.Model):
    ...
    @staticmethod
    def add(user_id, title, headline, description, primary_key, url, amazon_url,thumbnail):
        return Item(user_id=user_id, title=title, headline=headline, description=description, primary_key=primary_key, url=url, amazon_url=amazon_url, thumbnail=thumbnail)
